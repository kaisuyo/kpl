...
CharCode charCodes[256] = {
  ...
  CHAR_SPACE, CHAR_EXCLAIMATION, CHAR_QUOTATION, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_MODULUS, CHAR_UNKNOWN, CHAR_SINGLEQUOTE,
  ...
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LSEL, CHAR_UNKNOWN, CHAR_RSEL, CHAR_UNKNOWN, CHAR_LETTER,
