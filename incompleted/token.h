...
typedef enum {
  ...
  KW_INTEGER, KW_FLOAT, KW_CHAR, KW_ARRAY, KW_STRING, KW_OF, 
  ...
  SB_MODULUS, SB_ASSIGN_PLUS, SB_ASSIGN_SUBTRACT, SB_ASSIGN_DIVIDE, SB_ASSIGN_TIMES, SB_QUESTION, SB_QUOTATION,
} TokenType; 
